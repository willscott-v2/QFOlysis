      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-4">
            AI Content Coverage Analysis
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Discover content gaps and competitive opportunities using advanced AI semantic analysis.
            Compare your content against competitors and get actionable insights to improve your strategy.
          </p>
        </div>
